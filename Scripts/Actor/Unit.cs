...
public partial class Unit : ActorBase {
	...
	public override void _Ready() {
		...
		if (overheadLabel == null) GD.PrintErr("[Unit._Ready] Could not find an Animated sprite 3D on this Actor");
		interactionArea = GetNode<Area3D>(Constants.InteractionArea);
		if (interactionArea == null) GD.PrintErr("[Unit._Ready] Could not find an Animated sprite 3D on this Actor");
